...
r = d.reports.create!(doctor_id: d.id, patient: "003", rtype: "Gastroscopy", status: "unfinished")
d.reports.create!(doctor_id: d.id, patient: "003", rtype: "Colonoscopy", status: "finished")
